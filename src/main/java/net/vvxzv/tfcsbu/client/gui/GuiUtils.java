...
public class GuiUtils {
    ...
    public static final TextureBlitData TARGET = new TextureBlitData(GuiUtils.FORGING_BACKGROUND, Dimension.SQUARE_256, new UV(183, 1), new Dimension(5, 5));
    public static final TextureBlitData WORK = new TextureBlitData(GuiUtils.FORGING_BACKGROUND, Dimension.SQUARE_256, new UV(178, 1), new Dimension(5, 5));
