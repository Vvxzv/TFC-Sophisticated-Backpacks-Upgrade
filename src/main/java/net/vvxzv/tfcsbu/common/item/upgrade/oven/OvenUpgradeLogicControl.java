...
public class OvenUpgradeLogicControl extends CompositeWidgetBase<WidgetBase> {
    ...
    private static final TextureBlitData OVEN_BACKGROUND = new TextureBlitData(ResourceLocation.fromNamespaceAndPath("tfcsbu", "textures/gui/oven_background.png"), new Dimension(128, 128), new UV(0, 0), new Dimension(80, 80));
